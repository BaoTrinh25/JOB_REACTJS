      ...
      <div className="flex flex-col md:flex-row items-center justify-between">
        <div className="flex flex-col md:flex-row items-center md:space-x-4">
          <div className="text-left ml-20">
            ...
            <p className="text-gray-600">Hỗ trợ Ứng Viên và Nhà tuyển dụng</p>
          </div>
        </div>
        <div className="mt-4 md:mt-0">
          <p className="text-2xl font-bold text-gray-900">Mọi thắc mắc hay gặp vấn đề</p> 
            <p className='text-xl'>Liên hệ Nako để được giúp đỡ</p>
          ...
          <p className="mt-2 text-gray-600">Email hỗ trợ: <a href="mailto:hotro@nako.vn" className="text-green-600">hotro@nako.vn</a></p>
        </div>
